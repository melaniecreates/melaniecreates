	...
	render () {
      ...
      <ThemeProvider theme={theme}>
        <div>
          ...
          <section className="paypalPage mainContent">
              <div className="contentPadding pageHeading">
                    <h1>Paypal Corp.</h1>
                    <p>In 2016, I worked on a 3 month design and development contract for Paypal. </p>
                    ...
                    <section className="txtArea">
                      <div className="txt">
                        ...
                        <div className="multiColumn">
                          <p className="firstcharacter">This project took place between October 2016 and January 2017 in San Jose, California. <strong>I designed</strong> the interface, <strong>developed</strong> the website, and managed everything as a store owner. I controlled everything from sourcing products, administration and customer support.</p>
